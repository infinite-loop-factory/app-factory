// Minimal ISO 3166-1 numeric (3-digit, zero-padded) to alpha-2 mapping.
// Source data is factual (public domain). This subset covers world-atlas 110m countries.
// Extend as needed if you notice a missing code.
