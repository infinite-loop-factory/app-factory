...
### **Phase 2: UI 컴포넌트 개발 (Day 4-7)**

#### Day 4: 기본 컴포넌트
- [ ] QuestionCard 컴포넌트 (디자인 시스템 적용)
- [ ] CheckboxItem 컴포넌트
- [ ] HeaderBar 컴포넌트
- [ ] NavigationButton 컴포넌트

#### Day 5-6: 화면별 구현
- [ ] CategorySelectionScreen
- [ ] DifficultySelectionScreen  
- [ ] QuestionMainScreen
- [ ] ContinuousCardScreen (모드 1,2,3)

#### Day 7: 리스트 모드 구현
- [ ] QuestionListScreen (모드 4)
- [ ] IndividualCardScreen (모드 4)
- [ ] 화면 간 네비게이션 연결

### **Phase 3: 인터랙션 & 제스처 (Day 8-10)**
